...
var bounds = [621462.0625, 4133126,
    675955.1875, 4194953.5];
if (pureCoverage) {
...
var untiled = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: 'http://localhost:8080/geoserver/projectshp/wms',
        params: {'FORMAT': format,
            'VERSION': '1.1.1',
            "LAYERS": 'projectshp:fpoint',
...
var tiled = new ol.layer.Tile({
    ...
    source: new ol.source.TileWMS({
        ...
        params: {'FORMAT': format,
            ...
            "LAYERS": 'projectshp:fpoint',
            "exceptions": 'application/vnd.ogc.se_inimage',
            tilesOrigin: 621462.0625 + "," + 4133126
        }
    })
});
